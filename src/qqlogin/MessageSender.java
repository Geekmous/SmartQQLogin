...
public class MessageSender {
    ...
    class Sender implements Runnable {
        ...
        public void run() {
            ...
            String groupParam = "r={\"group_uin\":" + toUin + ",\"content\":\"[\\\"" + content + "\\\",[\\\"font\\\",{\\\"name\\\":\\\"宋体\\\",\\\"size\\\":10,\\\"style\\\":[0,0,0],\\\"color\\\":\\\"000000\\\"}]]\",\"face\":645,\"clientid\": "+ 53999199 + ",\"msg_id\":" + 33000001 + ",\"psessionid\":\"" + psessionid + "\"}";
            String personParam = "r={\"to\":" + toUin + ",\"content\":\"[\\\"" + content + "\\\",[\\\"font\\\",{\\\"name\\\":\\\"宋体\\\",\\\"size\\\":10,\\\"style\\\":[0,0,0],\\\"color\\\":\\\"000000\\\"}]]\",\"face\":645,\"clientid\": "+ 53999199 + ",\"msg_id\":" + 33000001 + ",\"psessionid\":\"" + psessionid + "\"}";
