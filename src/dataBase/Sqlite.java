...
public class Sqlite extends AbstractDataBase {
    ...
    public static void main(String ...strings) {
        ...
        String sql = "CREATE TABLE PERSONALMESSAGE " +
                    "(FROMUIN TEXT PRIMARY KEY    NOT NULL," +
                    "TOUIN         TEXT           NOT NULL," +
        ...
        for(int i = 1000; i < 20000; i++) {
            sql = "INSERT INTO PERSONALMESSAGE (FROMUIN, TOUIN, CONTENT, TIME)" +
                    "VALUES('" + i + "','321','ASD','DSA')";
            database.executeUpdata(sql);
        }
        ...
        try {
            while(rs.next()) {
                ...
                System.out.println("fromuin : " + fromuin + "  touin : " + touin + " content : " + content + "  time :" + time);
